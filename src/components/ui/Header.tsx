...
export default function Header({ products }: HeaderProps) {
  ...
  return (
    <>
      <header
        className="z-50 backdrop-blur-lg sm:backdrop-blur-xs fixed top-0 left-0 right-0 py-5 text-white/70 px-sectionX-m md:px-sectionX h-[104px] sm:h-[72px]"
        id="header"
      >
        <div
          className="relative w-full h-full flex flex-col gap-5 justify-between items-center"
          style={{
        ...
        >
          <div className="w-full flex items-center justify-between gap-5 h-full">
            ...
            <div className="hidden sm:flex items-center gap-5">
              <FlipTextOnHover text="Products" onClick={scrollToProducts} />

              <FlipTextOnHover text="Admin" href="/admin/" />
            </div>
