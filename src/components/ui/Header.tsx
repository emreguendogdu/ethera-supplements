    ...
    <>
      <header className="fixed top-0 left-0 right-0 flex items-center justify-between py-4 bg-black text-neutral-500 z-50 px-sectionX-m md:px-sectionX">
        ...
        <div className="flex items-center gap-8">
          {/* Cart Button */}
          <button
            className="flex gap-2 items-center group cursor-pointer focus:outline-none subheading text-neutral-500 group-hover:text-neutral-200 transition-all border border-neutral-500 px-4 py-1 rounded-full"
