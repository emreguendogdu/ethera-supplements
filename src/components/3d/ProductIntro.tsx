...
const animationSequence = (
  ...
  [position, { y: isMobile ? 0.7 : 0 }, { ...transition, at: 0 }],
  [rotation, { x: 0, y: 0 }, { ...transition, at: 0 }],
  [position, { x: isMobile ? 0 : -2 }, { ...transition, at: 1.45 }],
  [rotation, { y: isMobile ? 0.1 : 1 }, { ...transition, at: 1.45 }],
  [
    scale,
    { x: isMobile ? 0.8 : 1, y: isMobile ? 0.8 : 1, z: isMobile ? 0.8 : 1 },
    { ...transition, at: 1.45 },
  ],
  [
...
export default function ProductIntro({ slug, glbUrl }: ProductIntroProps) {
